...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (magit yaml-mode web-mode volatile-highlights undo-tree smartrep smartparens savekill rvm ruby-block rspec-mode rinari rhtml-mode revive recentf-ext rainbow-mode popwin point-undo phpunit php-mode neotree multiple-cursors markdown-mode kotlin-mode js2-mode init-loader helm-swoop helm-projectile helm-migemo helm-ls-git helm-gtags helm-go-package helm-flycheck helm-descbinds helm-c-yasnippet helm-ag groovy-mode go-eldoc go-autocomplete gitignore-mode git-gutter git-commit-mode fuzzy flycheck-pos-tip flycheck-kotlin feature-mode expand-region dockerfile-mode crontab-mode company-go color-theme avy anzu ac-ispell ac-helm)))

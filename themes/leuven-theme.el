...
(let ((class '((class color) (min-colors 89)))
      ...
      (ol6 '(:height 1.0 :weight bold :slant normal :foreground "#0077CC"))
      (ol7 '(:height 1.0 :weight bold :slant normal :foreground "#2EAE2C"))
      (ol8 '(:height 1.0 :weight bold :slant normal :foreground "#FD8008"))
  ...
  (custom-theme-set-faces
   ...
   `(trailing-whitespace ((t (:background "orange"))))
   ...
   `(whitespace-tab ((t (:foreground "orange"))))
   ...
   (if (version< emacs-version "24.4")
     ...
     `(flyspell-duplicate ((,class (:underline (:style wave :color "#F4EB80") :inherit nil)))))
   (if (version< emacs-version "24.4")
       `(flyspell-incorrect ((,class (:underline "#FAA7A5" :inherit nil))))
     `(flyspell-incorrect ((,class (:underline (:style wave :color "#FAA7A5") :inherit nil)))))
   ...
   `(org-document-title ((,class (:height 1.0 :weight bold :foreground "black"))))
